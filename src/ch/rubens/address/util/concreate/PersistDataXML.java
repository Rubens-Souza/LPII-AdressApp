...
import ch.rubens.address.util.abstracts.IPersistData;
import java.io.File;
 ...
 * @author rubens
 */
public class PersistDataXML implements IPersistData<File> {
    ...
    public PersistDataXML(String context, IListWrapper wrapper, MainApp main) throws JAXBException {
